...
public class Test6 extends BaseTest
{
    ...
    public void test6()
    {
        ...
        book1.setPublishDate1(new java.util.Date(System.currentTimeMillis()));
        book1.setPublishTime1(new java.util.Date(System.currentTimeMillis()));
        book1.setPublishTS1(new java.util.Date(System.currentTimeMillis()));
        book1.setPublishDate2(new java.sql.Date(System.currentTimeMillis()));
        book1.setPublishTime2(new java.sql.Date(System.currentTimeMillis()));
        book1.setPublishTS2(new java.sql.Date(System.currentTimeMillis()));
        ...
        book2.setBookType1(BookType.Documentation);
        book2.setBookType2(BookType.Documentation);
        book2.setBookType3(BookType.Roman);
        book2.setPublishDate1(new java.util.Date(System.currentTimeMillis()));
        book2.setPublishTime1(new java.util.Date(System.currentTimeMillis()));
        book2.setPublishTS1(new java.util.Date(System.currentTimeMillis()));
        book2.setPublishDate2(new java.sql.Date(System.currentTimeMillis()));
        book2.setPublishTime2(new java.sql.Date(System.currentTimeMillis()));
        book2.setPublishTS2(new java.sql.Date(System.currentTimeMillis()));
