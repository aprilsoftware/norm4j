...
CREATE TABLE book (id int GENERATED BY DEFAULT AS IDENTITY, name character varying(255) NOT NULL, author_id int NOT NULL, CONSTRAINT book_pkey PRIMARY KEY (id));
