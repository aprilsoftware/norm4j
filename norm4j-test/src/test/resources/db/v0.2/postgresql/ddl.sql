...
CREATE TABLE book (id int GENERATED BY DEFAULT AS IDENTITY, name character varying(255) NOT NULL, author_id int NOT NULL, description character varying(255), CONSTRAINT book_pkey PRIMARY KEY (id));
...
CREATE TABLE bookorderitem (id int GENERATED BY DEFAULT AS IDENTITY, order_id int NOT NULL, book_id int NOT NULL, CONSTRAINT bookorderitem_pkey PRIMARY KEY (id));
